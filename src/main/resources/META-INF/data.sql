...
insert into phones (id, owner, product, version, ios, color, cover, country, serialNr, year, information) values (-1, 'andrey andrey', 'smartfone', '5s', 'ios-12', 'white', 'classic/special Edition', 'chine', '314526734635', 1996,'zarabotaj')
